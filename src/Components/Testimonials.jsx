...
const Testimonials = () => {
  return (
    <div className='container mx-auto py-10 lg:px-32 w-full overflow-hidden min-h-full' id='Testimonials'>
        ...
        { testimonialsData.map((testimonial, index) => (
            <div key={index} className='max-w-[340px]  shadow-lg rounded px-8 py-12 text-center'>
                ...
                <div className='flex justify-center gap-1 text-red-500 mb-4'>
                    {Array.from({length: testimonial.rating},(item,index) => <img key={index} src={assets.star_icon}/>)}
                </div>
